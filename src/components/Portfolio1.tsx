        ...
        <div className="container">
          ...
          <div className="project-inner">
            ...
            <div className="row">
              ...
              <div className="col-md-5">
                <h3>การดำเนินการเปลี่ยนแปลงภาครัฐในยุคดิจิทัล</h3>
                <p>
              ...
              <div className="col-md-5">
                ...
                <p>
                  ...
                  >
                    ...
                    เหล่าพนักงานย่อมต้องเชื่อฟังและปฏิบัติตาม
                  </Link>
                </p>
                <p>
              ...
              <div className="col-md-5">
                ...
                <p>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    วิสัยทัศน์ร่วมเพื่อการเปลี่ยนแปลงคืออะไร?
                  </Link>
                </p>
                <p>
                  <ol style={{ listStyleType: "disc" }}>
                    ...
                    <li>
                      อะไรทำให้การเปลี่ยนแปลงเหล่านี้สร้างแรงบันดาลใจและน่าจดจำในระดับบุคคลทีม
                      และองค์กร?
                    </li>
                    <li>
                      การเปลี่ยนแปลงจะสอดคล้องกับกลยุทธ์โดยรวมขององค์กรของเรา
                    </li>
                    <li>จุดมุ่งหมายที่กว้างขึ้น และวัฒนธรรมองค์กรอย่างไร</li>
                  </ol>
                </p>
                <a
                  className="btn btn-primary"
              ...
              <div className="col-md-5">
                ...
                <p>
                  ...
                  >
                    ...
                    การวิเคราห์ผู้มีส่วนได้ส่วนเสีย
                  </Link>
                </p>
                <p>
          ...
          <div className="project-inner">
            <div className="row">
              ...
              <div className="col-md-5">
                <h3>การประคับประครองการเปลี่ยนแปลง </h3>
                <p>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    วิธีการปรับปรุงคุณภาพการส่งมอบการดูแลแบบประคับประครอง:
                ...
                <p>
                  ...
                  ที่เกี่ยวข้องกับการดูแลแบบประคับประครอง
                </p>
                <a
                  className="btn btn-primary"
